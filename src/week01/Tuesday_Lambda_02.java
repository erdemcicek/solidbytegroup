...
//List<Integer> list = List.of(3,44,54,53); // o3,e44,e54,o53
//System.out.println(commaSep(list));
//}
//public static String commaSep(List<Integer> list) {
...
//return list.stream().map(t->t%2==0 ? "e"+t : "o"+t).collect(Collectors.joining(","));
//return list.stream().map(t->t%2==0 ? "e"+t : "o"+t).reduce("",(x,y)->x+","+y);	 ,o3,e44,e54,o53
//return list.stream().map(t->t%2==0 ? "e"+t : "o"+t).reduce((x,y)->x+","+y);
...
//return list.stream().map(t->t%2==0 ? "e"+t+",": "o"+t+",").collect(StringBuilder::new, StringBuilder::append, StringBuilder::append).toString();
//return list.stream().map(t->t%2==0 ? "e"+t : "o"+t).collect(()->new StringBuilder(), (c,e)-> c.append(e), (c1, c2)->c1.append(c2)).toString();